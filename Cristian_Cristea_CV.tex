...
\begin{document}
    ...
    \section{Experience}
        ...
        1 year 2 months
            ...
            \begin{highlights}
                \item Completed onboarding training in embedded systems fundamentals, covering key topics such as microcontrollers, interrupts, and communication protocols (UART, I2C, and SPI).
